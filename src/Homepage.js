    ...
    return (
      ...
      >
        ...
        <div className="video-container">
          ...
          <div className="video">
            <div className="dsktp-vid">
              <Video videoId="Fe0OaLv6e0M" />
            </div>
            <div className="dsktp-vid">
              <Video videoId="Fe0OaLv6e0M" />
            </div>
        ...
        <div className="info">
          <div className="info1">
            ...
            <div>
              <img src={email} className="img1" />
              <span className="sp">abc@gmail.com</span>
            </div>
            <div>
              <img src={website} className="img1" />
              <span className="sp">Website.com</span>
            </div>
          </div>
          <div className="info2">
            <div>Company</div>
